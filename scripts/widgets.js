document.addEventListener('DOMContentLoaded', function () {
    ...
    class RatingWidget extends HTMLElement{
        constructor(){
            ...
            this.maxRating = this.getAttribute('max');
			this.shadowRoot.innerHTML = `
                ...
                <style>
                    ...
                    .rating_sys label {
                    color: var(--form-and-about-me-text-color, black);
                    cursor: pointer;
                    }
                ...
                <form action="https://httpbin.org/post" method="POST">
                    <label id="rating">How satisfied are you?</label>
                    ...
                    <output class="rating_message" style="display: none;"></output>
                </form>
            `;
        }

        connectedCallback(){
            const inputStar = this.shadowRoot.querySelectorAll('input[type="radio"]');
        ...
        starRating(ratingValue) {
            const ratingSys = this.shadowRoot.querySelector('.rating_sys');
            const messageElement = this.shadowRoot.querySelector('.rating_message');

            const ratingPercentage = (ratingValue / this.maxRating) * 100;
            let message = '';
            ...
            messageElement.className = 'rating_message';
            messageElement.textContent = message;

            ratingSys.style.display = 'none';
            messageElement.style.display = 'block';

            this.ratingSubmission(ratingValue);
        }

        ratingSubmission(ratingValue){
    ...
    class WeatherWidget extends HTMLElement{
        constructor(){
            ...
            <!--Credits to https://erikflowers.github.io/weather-icons/ for the icons-->
            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                <symbol id="cloudy" viewBox="0 0 30 30">
                ...
                <symbol id="sunny" viewBox="0 0 30 30">
                ...
                <symbol id="default" viewBox="0 0 30 30">
                ...
                <symbol id="fog" viewBox="0 0 30 30">
                    ...
                    c-0.23,0-0.43-0.09-0.6-0.26C7.07,24.55,6.98,24.34,6.98,24.11z"></path>
                </symbol>
            
                <symbol id="night-clear" viewBox="0 0 30 30">
                ...
                <symbol id="partly-cloudy" viewBox="0 0 30 30">
                ...
                <symbol id="rain" viewBox="0 0 30 30">
                ...
                <symbol id="thunderstorm" viewBox="0 0 30 30">
                    ...
                    c-0.14,0.1-0.24,0.25-0.3,0.45l-1.46,5.7c0,0.02,0,0.05-0.01,0.11C16.93,23.5,16.93,23.53,16.93,23.56z"></path>
                </symbol>
            
                <symbol id="windy" viewBox="0 0 30 30">
            ...
            <style>
                ...
                #weather_no_JS, #weather_updates, .weather_text{
                color: var(--primary-color);
                font-weight: bold;
                }
            ...
            <p id="weather_no_JS">Current Weather Conditions Unavailable</p>
            <p id="weather_updates" style="display: none;"></p>
        `;
        }
        ...
        fetchForecast() {
            const weatherNoJs = this.shadowRoot.getElementById('weather_no_JS');
            const weatherUpdates = this.shadowRoot.getElementById('weather_updates');
        
            weatherNoJs.style.display = 'none';
            ...
            .then(forecastData => {
                ...
                for (let i = 0; i < Math.min(2, periods.length); i++) {
                    ...
                    let iconId = this.iconMap[period.shortForecast] || "default";
            
                    if(period.isDaytime){
                        iconId = this.iconMap[period.shortForecast] || "sunny";
                    }
                    else{
                        iconId = this.iconMap[period.shortForecast] || "night-clear";
                    }
                ...
                weatherUpdates.innerHTML = forecast;
                weatherUpdates.style.display = 'block';
            })
            .catch(error => {
                console.error('Error fetching forecast:', error);
                weatherUpdates.innerHTML = 'Error fetching forecast.';
                weatherUpdates.style.display = 'block';
            });
        }
    }
